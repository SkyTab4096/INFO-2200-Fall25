...
namespace _2200_AndersonK_Assignment03
{
    ...
    {
        /// <summary>
        /// Constructor for the cat class that then passes values back to the base class
        /// </summary>
        /// <param name="skinType"></param>
        /// <param name="foodType"></param>
        public Cat(string skinType, string foodType) : base(skinType, foodType)
        {
